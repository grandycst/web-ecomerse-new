...
<div class="section">
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-12">
				<form method="post" action="keranjang/keranjang_update.php">
					<div class="order-summary clearfix">
						...
						if(isset($_SESSION['keranjang'])){
								...
								<table class="shopping-cart-table table">
									...
									// cek apakah produk sudah ada dalam keranjang
										...
										for($a = 0; $a < $jumlah_isi_keranjang; $a++){
											...
											<td class="text-right"><a class="main-btn icon-btn" href="keranjang/keranjang_hapus.php?id=<?php echo $i['produk_id']; ?>&redirect=keranjang"><i class="fa fa-close"></i></a></td>
							...
							<div class="pull-right">
								...
								<a class="primary-btn" href="?page=checkout">Check Out</a>
							</div>
							<?php
						}else{
