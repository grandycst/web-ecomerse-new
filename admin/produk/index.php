      ...
      <section class="col-lg-10 col-lg-offset-1">
        <div class="box box-info">
          ...
          <div class="box-header">
            ...
            <a href="?page=produk/produk_tambah" class="btn btn-info btn-sm pull-right"><i class="fa fa-plus"></i> &nbsp Tambah Produk Baru</a>              
          </div>
          <div class="box-body">
                ...
                <tbody>
                  ...
                  while($d = mysqli_fetch_array($data)){
                    ...
                    <tr>
                      ...
                      <td>                        
                        <a class="btn btn-warning btn-sm" href="?page=produk/produk_edit&id=<?php echo $d['produk_id'] ?>"><i class="fa fa-cog"></i></a>
                        <a class="btn btn-danger btn-sm" href="?page=produk/produk_hapus&id=<?php echo $d['produk_id'] ?>"><i class="fa fa-trash"></i></a>
                      </td>
                    </tr>
                    <?php 
                  }
