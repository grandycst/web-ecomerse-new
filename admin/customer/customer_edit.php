      ...
      <section class="col-lg-6 col-lg-offset-3">       
        <div class="box box-info">
          ...
          <div class="box-header">
            ...
            <a href="?page=customer/index" class="btn btn-info btn-sm pull-right"><i class="fa fa-reply"></i> &nbsp Kembali</a> 
          </div>
          <div class="box-body">
            ...
            while($d = mysqli_fetch_array($data)){
              ?>
              <form action="customer/customer_update.php" method="post">
