      ...
      <section class="col-lg-6 col-lg-offset-3">       
        <div class="box box-info">
          ...
          <div class="box-header">
            ...
            <a href="?page=admin/index" class="btn btn-info btn-sm pull-right"><i class="fa fa-reply"></i> &nbsp Kembali</a> 
          </div>
          <div class="box-body">
            <form action="admin/admin_act.php" method="post" enctype="multipart/form-data">
