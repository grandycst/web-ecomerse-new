          ...
          <div class="box-body">
           ...
           while($i = mysqli_fetch_array($invoice)){
            ...
            <div class="col-lg-12">
              ...
              <a href="index.php?page=transaksi/index" class="btn btn-primary btn-sm"><i class="fa fa-arrow-left"></i> KEMBALI</a>
              <a href="transaksi/transaksi_invoice_cetak.php?id=<?php echo $_GET['id'] ?>" target="_blank" class="btn btn-default btn-sm"><i class="fa fa-print"></i> CETAK</a>
