                ...
                <tbody>
                  ...
                  while($i = mysqli_fetch_array($invoice)){
                    ...
                    <tr>
                      ...
                      <td class="text-center">
                        <form action="transaksi/transaksi_status.php" method="post">
                      ...
                      <td class="text-center">    
                        ...
                        <a class='btn btn-sm btn-success' href="?page=transaksi/transaksi_invoice&id=<?php echo $i['invoice_id']; ?>"><i class="fa fa-print"></i> Invoice</a>
                        <a class='btn btn-sm btn-danger' href="?page=transaksi_hapus&id=<?php echo $i['invoice_id']; ?>"><i class="fa fa-trash"></i></a>
                      </td>
                    </tr>
                    <?php 
                  }
